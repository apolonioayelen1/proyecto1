...
/*16Mostrar todos los empleados que nacieron
entre 1970 y 1985.*/
...
WHERE YEAR (BirthDate) BETWEEN 1970 AND 1985;
 ...
 /*17Mostrar la fecha, número de cuenta y subtotal
...
WHERE OrderDate BETWEEN '2005-01-01' AND '2006-12-31';
 ...
 /*17Mostrar todas las órdenes de venta cuyo
...
/*18Mostrar los códigos de orden de venta, código
